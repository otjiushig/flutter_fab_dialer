...
class FabDialer extends StatefulWidget {
	...
	FabDialerState createState() =>
		FabDialerState(
			_fabMiniMenuItemList, _fabColor, _fabIcon, _closeFabIcon, _animationDuration);
}
...
class FabDialerState extends State<FabDialer> with TickerProviderStateMixin {
	...
	@override
	void initState() {
		final int animationDuration = _animationDuration == null ? 180 : _animationDuration;
	...
	Widget build(BuildContext context) {
		final Icon closeIcon = _closeFabIcon == null ? Icon(Icons.close) : _closeFabIcon;
		return Container(
